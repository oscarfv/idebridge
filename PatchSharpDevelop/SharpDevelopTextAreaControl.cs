...
//			newControl.TextArea.IconBarMargin.MouseDown += new MarginMouseEventHandler(IconBarMouseDown);
		...
		// IdeBridge
		protected void CloseCodeCompletionWindow(object sender, EventArgs e)
		{
		...
		protected void CloseInsightWindow(object sender, EventArgs e) // IdeBridge
		{
		...
		protected InsightWindow insightWindow = null; // IdeBridge
		protected CodeCompletionWindow codeCompletionWindow = null; // IdeBridge
