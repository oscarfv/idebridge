...
namespace ICSharpCode.TextEditor.Gui.CompletionWindow
{
	public class CodeCompletionWindow : AbstractCompletionWindow
	{
		...
		protected CodeCompletionListView codeCompletionListView; // IdeBridge
		...
		protected int startOffset; // IdeBridge
		protected int endOffset; // IdeBridge
		protected DeclarationViewWindow declarationViewWindow = null; // IdeBridge
		protected Rectangle workingScreen; // IdeBridge
		...
		// IdeBridge :
		protected CodeCompletionWindow(ICompletionDataProvider completionDataProvider, ICompletionData[] completionData, Form parentForm, TextEditorControl control, bool showDeclarationWindow, bool fixedListViewWidth) : base(parentForm, control)
		{
